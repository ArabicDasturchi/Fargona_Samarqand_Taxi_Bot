...
def select_direction_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="➡️ Farg'onadan -> Samarqandga", callback_data="dir_to_samarqand")],
        [InlineKeyboardButton(text="⬅️ Samarqanddan -> Farg'onaga", callback_data="dir_from_samarqand")]
    ])
...
def regions_keyboard(direction: str):
    ...
    regions = [
        ...
        "Qo'shtepa", "Bag'dod", "Buvayda", "Dang'ara", 
        "Furqat", "O'zbekiston", "Quva", "Rishton", "So'x", 
